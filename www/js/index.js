...
var Game = function () {
    ...
    * Display score
    ...
    Game.prototype.showGrade = function showGrade(score) {
        if (score > 30) return "Chuck Norris?";else if (score > 25) return "Encontramos Alien!";else if (score > 20) return "Impressionante";else if (score > 15) return "Ótimo!";else if (score > 13) return "Legal!";else if (score > 10) return "Bom trabalho!";else if (score > 5) return "Sério?";else return "Poh...";
    };
